...
By default, `passgen` uses a combination of lower and upper case Basic-Latin letters (i.e. "A-Z" and "a-z"). But you can use the available command-line options to change this character set, in order to produce passwords with different kinds of characters.
